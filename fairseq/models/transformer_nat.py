...
@register_model("transformer_enc_only")
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward_scriptable(
        ...
        # upsampling embeddings & embedding masks
        bs, sl = src_tokens.shape
        x, encoder_embedding = self.forward_embedding(src_tokens, token_embeddings)
        encoder_padding_mask = encoder_padding_mask.unsqueeze(-1).expand(bs, sl, int(self.upsample_coefficient)).contiguous().view(bs, -1)
...
@register_model_architecture("transformer_enc_only", "transformer_enc_only")
